...
function ActionTile(props: TileProps) {
  ...
  const shellClass =
    'relative overflow-hidden rounded-2xl px-5 py-8 md:px-6 md:py-10 flex items-center gap-4 group bg-white border border-neutral-200 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:border-neutral-300';
